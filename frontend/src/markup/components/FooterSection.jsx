        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/3 px-4 mb-8 md:mb-0">
            <div className="footer_block">
              ...
              <p className="mb-2">
                <span>📍</span> 16487 Fredrick RD Woodbine MD 21797
              </p>
              <p className="mb-2">
                <span>📞</span> +1 (240) 441 3923{" "}
              </p>
              <p className="mb-2">
                <span>📞</span> +1 (202) 262 8200{" "}
              </p>
              <p className="mb-4">
                <span>📧</span> zebibtegenu@anzfamilyfarm.com
              </p>
              ...
              <ul className="useful_links space-y-2">
                <li>
                  <a href="/order" className="flex items-center">
                    <FaAngleRight className="mr-2" /> Shop
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <FaAngleRight className="mr-2" /> Our Range
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="flex items-center"
                  >
                    <FaAngleRight className="mr-2" /> About Us
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="flex items-center"
                  >
                    <FaAngleRight className="mr-2" /> Service
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="flex items-center"
                  >
                    <FaAngleRight className="mr-2" /> Gallery
                  </a>
                </li>
              </ul>
            </div>
              ...
              <ul className="useful_links space-y-2">
                <li>
                  <a href="#" className="flex items-center">
                    <FaAngleRight className="mr-2" /> Lamb
                  </a>
                </li>
                <li>
                  <a href="#" className="flex items-center">
                    <FaAngleRight className="mr-2" /> Goat
                  </a>
                </li>
